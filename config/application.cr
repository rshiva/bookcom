...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Bookcon web application."
  #
  #
  ...
  #
  # settings.secret_key_base= i2mVOcqqF6uqAHOyHrN4p7SJjVJSg6q0lPvJuXNLt-M
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("bookcon.log", "w"))
  #
  #
end
